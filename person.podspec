...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "LJC" => "924488401@qq.com" }
  # Or just: spec.author    = "LJC"
  # spec.authors            = { "LJC" => "924488401@qq.com" }
  # spec.social_media_url   = "https://twitter.com/LJC"
